...
$sqll = "SELECT * FROM infoss WHERE mdp='$ancmdp'";
$sqlll="SELECT * FROM infoss WHERE mail='$ancmail'";
...
if($result->num_rows == 0){
   ...
   $sql = "UPDATE infoss SET mdp='$nvmdp' WHERE mdp='$ancmdp'";
   $sqli= "UPDATE infoss SET mail='$nvmail' WHERE mail='$ancmail'";
